...
function moveSnake(input)
{
    ...
    {
        case 0:
            x = (snake[0].xPos/blockWidth) + 1;
            y = (snake[0].yPos/blockWidth);
            break;
        case 1:
            x = (snake[0].xPos/blockWidth);
            y = (snake[0].yPos/blockWidth) + 1;
            break;
        case 2:
            x = (snake[0].xPos/blockWidth) - 1;
            y = (snake[0].yPos/blockWidth);
...
function draw()
{
    ...
    bctx.fillStyle = 'rgb(176, 196, 222)';
    bctx.fillRect(0, 0, bctx.canvas.width, bctx.canvas.height);

    bctx.fillStyle = 'rgb(255, 97, 3)';

    
    snake.forEach(s => bctx.fillRect(s.xPos,s.yPos,blockWidth,blockWidth));

    bctx.fillStyle = 'rgb(255, 0, 0)';

    bctx.fillRect(appleLoc[0], appleLoc[1], blockWidth, blockWidth);
